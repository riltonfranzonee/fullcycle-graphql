...
func (ec *executionContext) _Course_chapters(ctx context.Context, field graphql.CollectedField, obj *model.Course) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOChapter2ᚕᚖgithubᚗcomᚋcodeeduᚋfc2ᚑgraphqlᚋgraphᚋmodelᚐChapterᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOChapter2ᚕᚖgithubᚗcomᚋcodeeduᚋfc2ᚑgraphqlᚋgraphᚋmodelᚐChapterᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Chapter) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
